...
#music and sounds
music = pygame.mixer.Sound('fruit-ninja-game-python-code/Ripleys Rescues.mp3')
gameover_music = pygame.mixer.Sound('fruit-ninja-game-python-code/gameover1.wav')
alien_screem = pygame.mixer.Sound('fruit-ninja-game-python-code/hiss2.wav')
...
fruits = ['facehugger1', 'facehugger2', 'chestburster4', 'chestburster3', 'bomb', 'xeno']    
...
back = pygame.image.load('fruit-ninja-game-python-code/images/back.gif') 
background = pygame.image.load('fruit-ninja-game-python-code/images/background.png')                                  #game background
font = pygame.font.Font(os.path.join(os.getcwd(), 'fruit-ninja-game-python-code/comic.ttf'), 42)
score_text = font.render('Score : ' + str(score), True, (255, 255, 255))    #score display
lives_icon = pygame.image.load('fruit-ninja-game-python-code/images/white_lives.png')                    #images that shows remaining lives

# Generalized structure of the fruit Dictionary
def generate_random_fruits(fruit):
    fruit_path = "fruit-ninja-game-python-code/images/" + fruit + ".png"
    data[fruit] = {
        'img': pygame.image.load(fruit_path),
        'x' : random.randint(200,500),          #where the fruit should be positioned on x-coordinate
        'y' : 800,
...
def hide_cross_lives(x, y):
    gameDisplay.blit(pygame.image.load("fruit-ninja-game-python-code/images/red_lives.png"), (x, y))
...
while game_running :
    if game_over :
        ...
        game_over = False
        player_lives = 3
        draw_lives(gameDisplay, 690, 5, player_lives, 'fruit-ninja-game-python-code/images/red_lives.png')
        score = 0
        ...
        if value['throw']:
            ...
            if not value['hit'] and current_position[0] > value['x'] and current_position[0] < value['x']+60 \
                ...
                if key == 'bomb':
                    ...
                    half_fruit_path = "fruit-ninja-game-python-code/images/explosion.png"
                else:
                    half_fruit_path = "fruit-ninja-game-python-code/images/" + "half_" + key + ".png"
                    alien_screem.play()
